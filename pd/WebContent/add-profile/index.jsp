...
<head>
	...
	<script type="text/javascript" src="./../resources/ajax/SendData.js"></script>
	...
	<div class="container" style="margin-top: 100px">
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 d-flex justify-content-center">
				<label for="profileImage" class="cus-click">
					<img id="profileImageShow" class="rounded-circle" alt="profile picture" style="width: 180px; height: 180px;"  src="./../resources/images/img_avatar.png">
				</label>
				<input id="profileImage" type="file" onchange="document.getElementById('profileImageShow').src = window.URL.createObjectURL(this.files[0])">
			</div>
		...
		<div class="row" style="margin-top: 50px; font-size: 20px;">
			<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 text-center">
				...
				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-signature"></i></span>
    				<input id="otherName" type="text" class="form-control" name="otherName" placeholder="Other Name">
				</div>
				...
				<div class="input-group mt-3">
    				...
    				<input id="fatherName" type="text" class="form-control" name="fatherName" placeholder="Father's Name">
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-users"></i></span>
    				<input id="motherName" type="text" class="form-control" name="motherName" placeholder="Mother's Name">
				</div>
			...
			<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 text-center">
				...
				<div class="input-group mt-3">
    				...
    				<input id="profession" type="text" class="form-control" name="profession" placeholder="Profession">
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-briefcase"></i></span>
    				<input id="presentWork" type="text" class="form-control" name="presentWork" placeholder="Present Work Space">
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-briefcase"></i></span>
    				<input id="pastWork" type="text" class="form-control" name="pastWork" placeholder="Past Work Space">
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-graduation-cap"></i></span>
    				<input id="education" type="text" class="form-control" name="education" placeholder="Education">
				</div>
			...
			<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 text-center">
				...
				<div class="input-group mt-3">
    				...
    				<input id="phno" type="text" class="form-control" name="phno" placeholder="Phone Number">
				</div>
				...
				<div class="input-group mt-3">
    				...
    				<input id="facebook" type="text" class="form-control" name="facebook" placeholder="Facebook profile link">
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fab fa-instagram"></i></span>
    				<input id="instagram" type="text" class="form-control" name="instagram" placeholder="Instagram profile link">
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fab fa-twitter-square"></i></span>
    				<input id="twiter" type="text" class="form-control" name="twiter" placeholder="Twiter profile link">
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fab fa-github-square"></i></span>
    				<input id="github" type="text" class="form-control" name="github" placeholder="Git Hub profile link">
				</div>
		...
		<div class="row" style="margin-top: 50px; font-size: 20px;">
			<div class="col-12">
				<div class="input-group mt-3">
    				<button class="btn-dark mx-auto rounded" type="button" onclick="sendInfo();">Submit</button>
    			</div>
			</div>
