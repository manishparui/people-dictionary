...
<head>
	...
	<script type="text/javascript" src="./../resources/ajax/UpdateData.js"></script>
	...
	<div class="container" style="margin-top: 100px">
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 d-flex justify-content-center">
				<img id="pic" class="rounded-circle" style="width: 180px; height: 180px;"  src="./../resources/images/img_avatar.png">
			</div>
		...
		<div class="row" style="margin-top: 50px; font-size: 20px;">
			<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 text-center">
				...
				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-signature"></i></span>
    				<textarea id="otherName" class="form-control" name="otherName" placeholder="Other Name" rows="2"></textarea>
				</div>
				...
				<div class="input-group mt-3">
    				...
    				<textarea id="fatherName" class="form-control" name="fatherName" placeholder="Father's Name" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-users"></i></span>
    				<textarea id="motherName" class="form-control" name="motherName" placeholder="Mother's Name" rows="2"></textarea>
				</div>
			...
			<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 text-center">
				...
				<div class="input-group mt-3">
    				...
    				<textarea id="profession" type="text" class="form-control" name="profession" placeholder="Profession" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-briefcase"></i></span>
    				<textarea id="presentWork" class="form-control" name="presentWork" placeholder="Present Work Space" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-briefcase"></i></span>
    				<textarea id="pastWork" class="form-control" name="pastWork" placeholder="Past Work Space" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-graduation-cap"></i></span>
    				<textarea id="education" class="form-control" name="education" placeholder="Education" rows="2"></textarea>
				</div>
			...
			<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 text-center">
				...
				<div class="input-group mt-3">
    				...
    				<textarea id="address" class="form-control" name="address" placeholder="Address" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-phone"></i></span>
    				<textarea id="phno" class="form-control" name="phno" placeholder="Phone Number" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fas fa-envelope"></i></span>
    				<textarea id="email" class="form-control" name="email" placeholder="Email" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fab fa-facebook"></i></span>
    				<textarea id="facebook" class="form-control" name="facebook" placeholder="Facebook profile link" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fab fa-instagram"></i></span>
    				<textarea id="instagram" class="form-control" name="instagram" placeholder="Instagram profile link" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fab fa-twitter-square"></i></span>
    				<textarea id="twiter" class="form-control" name="twiter" placeholder="Twiter profile link" rows="2"></textarea>
				</div>

				<div class="input-group mt-3">
    				<span class="input-group-text" style="font-size: 24px"><i class="fab fa-github-square"></i></span>
    				<textarea id="github" class="form-control" name="github" placeholder="Git Hub profile link" rows="2"></textarea>
				</div>
			...
			<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 text-center">
				...
				<div class="input-group mt-3">
    				...
    				<textarea id="other" class="form-control" name="other" placeholder="Other Information" rows="10"></textarea>
				</div>
		...
		<div class="row" style="margin-top: 50px; font-size: 20px;">
			<div class="col-12">
				<div class="input-group mt-3">
    				<button class="btn-dark mx-auto rounded" type="button" onclick="updateDataCheck(<%=id %>)">Update</button>
    			</div>
			</div>
